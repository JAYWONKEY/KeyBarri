...
class FaceRecognitionKiosk:
    def __init__(self):
        ...
        self.CASCADE_PATH = '123\por0502\haarcascade_frontalface_default.xml'
        self.RESULT_CSV = '결과_로그.csv'
        self.MENU_FILE = '123\por0502\process_data.csv'
...
def get_age_from_camera():
    ...
    face_cascade = cv2.CascadeClassifier('123\por0502\haarcascade_frontalface_default.xml')
